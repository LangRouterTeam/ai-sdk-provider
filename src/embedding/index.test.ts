...
import { LangRouterEmbeddingModel } from './index';

describe('LangRouterEmbeddingModel', () => {
  ...
  describe('provider methods', () => {
    ...
    it('should create an embedding model instance', () => {
      ...
      expect(model).toBeInstanceOf(LangRouterEmbeddingModel);
  ...
  describe('doEmbed', () => {
    it('should embed a single value', async () => {
      ...
      expect(
        (result.providerMetadata?.langrouter as { usage?: { cost?: number } })
          ?.usage?.cost,
      ).toBe(0.00001);
    });
