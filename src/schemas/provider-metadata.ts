...
/**
 * Schema for LangRouter provider metadata attached to responses
 */
export const LangRouterProviderMetadataSchema = z
  .object({
    provider: z.string(),
...
export type LangRouterProviderMetadata = z.infer<
  typeof LangRouterProviderMetadataSchema
>;

/**
 * Schema for parsing provider options that may contain reasoning_details and annotations
 */
export const LangRouterProviderOptionsSchema = z
  .object({
    langrouter: z
      .object({
        reasoning_details: z.array(ReasoningDetailUnionSchema).optional(),
