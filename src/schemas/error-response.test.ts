...
describe('LangRouterErrorResponseSchema', () => {
  it('should be valid without a type, code, and param', () => {
    ...
    const result = LangRouterErrorResponseSchema.parse(
  ...
  it('should be invalid with a type', () => {
    ...
    const result = LangRouterErrorResponseSchema.parse(errorWithType);
...
describe('extractErrorMessage', () => {
  function makeErrorData(message: string, metadata?: Record<string, unknown>) {
    return LangRouterErrorResponseSchema.parse({
