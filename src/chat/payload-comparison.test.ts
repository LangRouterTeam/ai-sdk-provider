...
import type { LangRouterChatCompletionsInput } from '../types/langrouter-chat-completions-input';
...
describe('Payload Comparison - Large PDF', () => {
  it('should send payload matching fetch baseline for large PDFs', async () => {
    interface CapturedRequestBody {
      model: string;
      messages: LangRouterChatCompletionsInput;
      plugins?: LangRouterChatSettings['plugins'];
    ...
    // This is what the fetch example sends and what LangRouter expects
