...
const provider = createLangRouter({
  baseURL: 'https://test.langrouter.ai/api/v1',
  apiKey: 'test-api-key',
});

const server = createTestServer({
  'https://test.langrouter.ai/api/v1/chat/completions': {},
});
...
describe('HTTP 200 Error Response Handling', () => {
  describe('doGenerate', () => {
    it('should throw APICallError for HTTP 200 responses with error payloads', async () => {
      // LangRouter sometimes returns HTTP 200 with an error object instead of choices
