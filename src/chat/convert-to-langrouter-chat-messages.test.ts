...
describe('user messages', () => {
  it('should convert image Uint8Array', async () => {
    const result = convertToLangRouterChatMessages([
      {
        role: 'user',
        content: [
  ...
  it('should throw error for audio URLs', async () => {
    expect(() =>
      convertToLangRouterChatMessages([
        {
          role: 'user',
          content: [
            {
...
describe('cache control', () => {
  ...
  it('should convert system message to array content with langrouter namespace cache control', () => {
    const result = convertToLangRouterChatMessages([
      {
        role: 'system',
        content: 'System prompt',
