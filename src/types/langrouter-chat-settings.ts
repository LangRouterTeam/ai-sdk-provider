...
*/
  ...
  plugins?: Array<
    ...
    | {
        /**
         * Auto-router plugin - configures allowed models when using `langrouter/auto`.
         *
  ...
  web_search_options?: {
     ...
     * @see https://langrouter.ai/docs/features/web-search
     */
    engine?: Engine;
  };
   ...
   * @see https://langrouter.ai/docs/api-reference/debugging
   */
  debug?: {
    /**
