/**
 * LangRouter API types - locally defined to avoid external SDK dependency.
 * These types mirror the LangRouter API specification.
 */

/**
 * Error structure returned by LangRouter API.
 */
 ...
 * @see https://langrouter.ai/docs/guides/features/plugins/response-healing
 */
export type IdResponseHealing = 'response-healing';

/**
 * Plugin identifier for auto-router model selection.
 * Configures allowed models when using the langrouter/auto model.
 * @see https://langrouter.ai/docs/guides/routing/routers/auto-router
 */
